//Common file for getting forces from a thruster

#include "ShipsCommon.as"
#include "BlockCommon.as"

const f32 THRUSTER_SPEED = 0.9f;//0.9f

void ThrusterForces(CBlob@ this,
					 Ship@ ship,
					 float power,
					 Vec2f &out moveVel,
					 Vec2f &out moveNorm,
					 float &out angleVel)
{
	...
	moveVel = Vec2f(0.0f, THRUSTER_SPEED * power);
...
void ThrusterForces(CBlob@ this, Ship@ ship, float power, Vec2f &out moveVel, float &out angleVel)
{
	Vec2f _a;
	ThrusterForces(this, ship, power, moveVel, _a, angleVel);
}